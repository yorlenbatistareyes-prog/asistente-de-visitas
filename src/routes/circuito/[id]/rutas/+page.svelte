...
<style>
  ...
  .btn-primary:hover { background-color: #3a0411 !important; transform: translateY(-1px); }
  ...
  .ruta-item {
    ...
    border-radius: 12px;
    background: var(--bg-panel) !important; /* 🔥 MODO OSCURO CORREGIDO */
  ...
  .fecha-bloque {
    background: var(--bg-app, #f1f5f9); /* 🔥 ADAPTATIVO */
    border: 1px solid var(--border-color);
    border-radius: 8px;
    padding: 6px 12px;
    display: flex;
  ...
  .detalles h5 { 
    margin: 0;
    font-size: 1.05rem; 
    color: var(--text-main) !important; /* 🔥 TEXTO VISIBLE */
    font-weight: 700; 
    line-height: 1.2;
  }

  /* BLOQUE DE ASIGNACIÓN (Adaptado a modo oscuro y claro) */
  .asignacion-bloque {
    display: flex;
    align-items: center;
    gap: 8px;
    background: rgba(16, 185, 129, 0.1); /* 🔥 ADAPTATIVO */
  ...
  .asignado-nombre {
    font-size: 0.8rem;
    color: #10b981; /* 🔥 VERDE BRILLANTE VISIBLE */
    font-weight: 800;
    overflow: hidden;
  ...
  .btn-mini {
    height: 26px; padding: 0 12px; font-size: 0.7rem; font-weight: 700; border-radius: 13px; 
    background: transparent; border: 1px solid #10b981; color: #10b981; cursor: pointer; transition: all 0.2s; white-space: nowrap; flex-shrink: 0;
  }
  .btn-mini:hover { background: #10b981; color: white; }

  /* ACCIONES DERECHA */
  .acciones-ruta { display: flex; align-items: center; gap: 10px; flex-shrink: 0; }
  ...
  /* ESTADOS Y MODAL */
  .empty-state { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 40px 20px; border-style: dashed; border-color: var(--border-color); color: var(--text-muted); background: var(--bg-panel); border-radius: 12px; }
  ...
  .modal-content { width: 100%; max-width: 440px; background: var(--bg-panel) !important; color: var(--text-main) !important; border-radius: var(--radius-lg); padding: 0; overflow: hidden; box-shadow: var(--shadow-3d); animation: scaleIn 0.2s ease-out; }
  ...
  .modal-actions { display: flex; justify-content: flex-end; gap: 10px; padding: 15px 20px; background: var(--bg-app); border-top: 1px solid var(--border-color); }
